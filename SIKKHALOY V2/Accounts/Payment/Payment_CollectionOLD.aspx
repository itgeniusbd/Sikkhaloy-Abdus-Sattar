<%@ Page Title="Collect Payment" Language="C#" MasterPageFile="~/BASIC.Master" AutoEventWireup="true" CodeBehind="Payment_CollectionOLD.aspx.cs" Inherits="EDUCATION.COM.ACCOUNTS.Payment.Payment_CollectionOLD" %>
    ...
    <div id="payment-container" class="table-responsive">
        <asp:GridView ID="DueGridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataKeyNames="Role,PayOrderID,Amount,StudentID,StudentClassID,RoleID,PayFor,StartDate,EducationYearID" DataSourceID="DueSQL" OnRowDataBound="DueGridView_RowDataBound">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Concession" SortExpression="Concession" ValidateRequestMode="Disabled">
                    <ItemTemplate>
                        <asp:TextBox ID="ConcessionTextBox" runat="server" Enabled="false" CssClass="form-control concession-input" Text='<%# Eval("Discount") %>' autocomplete="off"></asp:TextBox>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Late Fee" SortExpression="LateFee">
                    <ItemTemplate>
                        <asp:TextBox ID="LateFeeTextBox" runat="server" Enabled="false" CssClass="form-control latefee-input" Text='<%# Eval("LateFee") %>' autocomplete="off"></asp:TextBox>
                ...
                <asp:TemplateField HeaderText="Pay" SortExpression="Due">
                    <ItemTemplate>
                        <asp:TextBox ID="DueAmountTextBox" required="" Enabled="false" CssClass="form-control due-input" runat="server" Text='<%# Eval("Due") %>' autocomplete="off" />
                    </ItemTemplate>
                    <ItemStyle Width="150px" />
                </asp:TemplateField>
            </Columns>
        ...
        <asp:GridView ID="OtherSessionGridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataKeyNames="PayOrderID,Amount,StudentID,StudentClassID,RoleID,PayFor,StartDate,EducationYearID" DataSourceID="OtherSessionSQL" OnRowDataBound="OtherSessionGridView_RowDataBound">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Pay" SortExpression="Due">
                    <ItemTemplate>
                        <asp:TextBox ID="Other_Session_AmountTextBox" required="" Enabled="false" CssClass="form-control due-input" runat="server" Text='<%# Eval("Due") %>' autocomplete="off" />
                    </ItemTemplate>
                    <ItemStyle Width="150px" />
                </asp:TemplateField>
            </Columns>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="OAmountTextBox" runat="server" CssClass="form-control" placeholder="Input amount"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label>Concession</label>
                        <asp:TextBox ID="OConcessiontBox" runat="server" CssClass="form-control" autocomplete="off" placeholder="Input Concession"></asp:TextBox>
                    </div>
                    <div class="form-group">
...
const row = concessionInput.closest("tr");
            ...
            // Get Fee column (index 6), LateFee input (index 8), Paid column (index 9)
  ...
  const fee = parseFloat(feeCell.innerText) || 0;
      ...
      const concession = parseFloat(concessionInput.value) || 0;
        ...
        // Skip validation if already overpaid (Fee + LateFee <= Paid)
