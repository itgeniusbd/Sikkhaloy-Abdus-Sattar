<%@ Page Title="Collect Payment By Date" Language="C#" MasterPageFile="~/BASIC.Master" AutoEventWireup="true" CodeBehind="Payment_Collection_By_DateODL.aspx.cs" Inherits="EDUCATION.COM.Accounts.Payment.Payment_Collection_By_Date" %>
        ...
        <asp:GridView ID="DueGridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataKeyNames="Role,PayOrderID,Amount,StudentID,StudentClassID,RoleID,PayFor,StartDate,EducationYearID" DataSourceID="DueSQL" OnRowDataBound="DueGridView_RowDataBound">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Late Fee" SortExpression="LateFee">
                    <ItemTemplate>
                        <asp:TextBox ID="LateFeeTextBox" runat="server" Enabled="false" CssClass="form-control latefee-input" Text='<%# Eval("LateFee") %>' autocomplete="off" />
