<%@ Page Title="Accounts by user" Language="C#" MasterPageFile="~/BASIC.Master" AutoEventWireup="true" CodeBehind="UserAccount.aspx.cs" Inherits="EDUCATION.COM.Accounts.Reports.UserAccount" EnableViewState="false" %>
<%@ OutputCache Duration="300" VaryByParam="RegID;From_Date;To_Date" Location="ServerAndClient" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="CSS/Accounts_By_User.css?v=5" rel="stylesheet" />
    <style>
/* Loading Spinner */
        .loading-overlay {
   position: fixed;
...
// Show loading overlay
  ...
  // Hide loading once page is fully loaded
...
$(function () {
 ...
 var src = $img.attr('src');
        if (src && src.indexOf('Admin_Photo.ashx') > -1) {
