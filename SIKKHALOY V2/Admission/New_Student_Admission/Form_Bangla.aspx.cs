...
{
    public partial class Form_Bangla : System.Web.UI.Page
    {
        ...
        protected void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            {
                msgLabel.Text = "দয়া করে Student ID দিন";
                return;
            }

            if (Session["SchoolID"] == null)
            {
                msgLabel.Text = "Session হারিয়ে গেছে! আবার login করুন।";
                return;
            }
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            if (reader.Read())
                            {
                                ...
                                Response.Redirect($"Form_Bangla.aspx?Student={studentIDValue}&Student_Class={studentClassID}", false);
                            }
                            else
                            {
                                msgLabel.Text = $"'{studentID}' ID দিয়ে কোন শিক্ষার্থী পাওয়া যায়নি!";
                            }
                        }
                    }
                }
