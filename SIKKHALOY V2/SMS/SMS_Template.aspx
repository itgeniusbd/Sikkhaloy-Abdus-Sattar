        ...
        <div class="tab-content" id="categoryTabContent">
            ...
            <div class="tab-pane fade" id="donor-panel" role="tabpanel">
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-info">
                            <strong>🤝 Donor SMS Templates (ডোনার এসএমএস টেমপ্লেট):</strong><br />
                            <div style="margin-top: 10px;">
                                <strong>Available Placeholders (ব্যবহারযোগ্য প্লেসহোল্ডার):</strong><br />
                                <span class="placeholder-tag">{DonorName}</span>
                                <span class="placeholder-tag">{Amount}</span>
                                <span class="placeholder-tag">{ReceiptNo}</span>
                                <span class="placeholder-tag">{PaymentDetails}</span>
                                <span class="placeholder-tag">{TotalDue}</span>
                                ...
                                • 💸 <strong>DonorDue</strong> - ডোনার বকেয়া নোটিফিকেশন (Placeholders: DonorName, TotalDue, DueDetails, SchoolName)<br />
                                • ✅ <strong>DonorPayment</strong> - ডোনার পেমেন্ট কনফার্মেশন (Placeholders: DonorName, Amount, ReceiptNo, PaymentDetails, CurrentDue, SchoolName)<br />
                                • 🙏 <strong>DonorThankYou</strong> - ডোনার ধন্যবাদ মেসেজ (Placeholders: DonorName, Amount, SchoolName)<br />
                                • 📋 <strong>DonorReminder</strong> - ডোনার রিমাইন্ডার (Placeholders: DonorName, TotalDue, DueDetails, SchoolName)
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="TemplateCategoryDropDownList" runat="server" CssClass="form-control" 
                            ...
                            <asp:ListItem Value="Donor">🤝 Donor (ডোনার এসএমএস)</asp:ListItem>
