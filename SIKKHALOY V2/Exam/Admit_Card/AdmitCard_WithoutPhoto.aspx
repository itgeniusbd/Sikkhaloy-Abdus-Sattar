...
<div class="Card_Title1"><img src="../../CSS/Image/admintpic.png" /></div>
                            ...
                            <table style="margin-bottom:20px;margin-left:15px">
                                ...
                                <tr>
                                    <td>আসন নং</td>
                                    <td>:</td>
                                    <td style="font-weight:bold"><%# String.IsNullOrEmpty(Eval("SeatNo").ToString()) ? "-" : Eval("SeatNo") %></td>
                                </tr>
                                <tr>
                                    <td>ইস্যূ তারিখ</td>
                                    <td>:</td>
