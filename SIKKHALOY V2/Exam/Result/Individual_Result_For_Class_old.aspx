<%@ Page Title="Individual Exam Result" Language="C#" MasterPageFile="~/BASIC.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Individual_Result_For_Class_old.aspx.cs" Inherits="EDUCATION.COM.Exam.Result.Individual_Result_For_Class" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h3>Individual Exam Result  <a href="Individual_Result_For_Class.aspx"><span class="btn-text-full"> ---> New</span></a></h3>
