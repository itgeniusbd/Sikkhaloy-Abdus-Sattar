...
ঠিকানা: <strong><%# Eval("StudentPermanentAddress")%></strong>। আমার নিকট সে ব্যাক্তিগত ভাবে পরিচিত। আমার জানামতে সে রাষ্ট্র বিরোধী কোন কার্যক্রমে জড়িত নয়। 
     ...
     <label class="date-position" style="float: right;font-size: 18px;margin-right:20px;margin-top:300px; font-weight:bold;border-top:solid 1px #000">কর্তীপক্ষের স্বাক্ষর</label> 
</div>
</div>
  </ItemTemplate>
    </asp:FormView>
